...
class SequenceGenerator(object):
    ...
    def generate_batched_itr(
        ...
        for n,sample in enumerate(data_itr):
    ...
    def generate(self, encoder_input, iter_id, beam_size=None, maxlen=None, prefix_tokens=None):
        ...
        """
        with torch.no_grad():
            return self._generate(encoder_input, iter_id, beam_size, maxlen, prefix_tokens)

    def _generate(self, encoder_input, iter_id, beam_size=None, maxlen=None, prefix_tokens=None):
        """See generate"""
        ...
        for step in range(maxlen + 1):  # one extra step for EOS marker
            ...
            if iter_id not in self.js:
                self.js[iter_id]={}
            self.js[iter_id][step]=lprobs.tolist()
