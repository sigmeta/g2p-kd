...
def main(args):
    ...
    summary_writer = SummaryWriter(log_dir=os.environ['HOME'], enable=args.distributed_rank == 0)
    ...
    while lr > args.min_lr and epoch_itr.epoch < max_epoch and trainer.get_num_updates() < max_update:
        ...
        if epoch_itr.epoch % args.validate_interval == 0:
            valid_losses = validate(args, trainer, task, epoch_itr, valid_subsets, summary_writer)
...
def validate(args, trainer, task, epoch_itr, subsets, summary_writer=None):
